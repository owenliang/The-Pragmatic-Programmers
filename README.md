...
要想活的真实的洞察力，需要关闭L型，启动R型做其最合适的工作。
...
L型和R型处理过程截然不同，但是在你的大脑中它们存在一个汇合之处，一个创造力转化新创意的地方。

L型和R型在隐喻上（也就是创建类比的过程中）相同（汇合）。
...
当你努力解决一个难题时，你的所有记忆都会被扫描，甚至是那些你没有索引的记忆（相当于SQL的全表扫描），这是这的确能解决问题。
...
写博客很受欢迎，一旦开始写作就一定要注意坚持不懈，不要为了技术问题而分心，不必担心是否还需润色，先把它们都写下来。
